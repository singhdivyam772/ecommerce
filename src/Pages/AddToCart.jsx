      ...
      <div className=' flex flex-col justify-start items-start w-screen min-h-[50rem] px-6 mb-5'>
         ...
         <section className=' w-full flex lg:flex-row flex-col justify-start items-start gap-2'>
           ...
           { <div className=' w-full overflow-x-auto '>
               <table className='w-full'>
                  <thead className='sticky top-0 text-center md:text-sm text-xs'>
                     <tr className=''>
                        ...
                        <th className='w-[25%] py-2 border-[0.1rem] border-pink-300 text-pink-600 md:text-xl font-normal'>Product Details</th>
                        ...
                        <th className='w-[20%] py-2 leading-10 border-[0.1rem] border-pink-300 text-pink-600 md:text-xl font-normal'>Action</th>
                     </tr>
                  </thead>
            ...
            {/* Subtotal */}
            <section className=' flex flex-col md:w-[25%] w-full px-5 md:py-5 bg-pink-100 md:h-[14rem] h-[10rem] rounded-lg' >
            
            <div className=' flex justify-between items-center '>
               <p className=' font-medium md:text-xl text-base leading-10 text-pink-600'>SubtTotal</p>
               <p className=' font-medium md:text-xl text-base leading-10 text-pink-600'>Rs. 7,354.40</p>
            </div>
            <p className=' font-medium text-sm leading-7 text-pink-600'>
               Tax included. Shipping calculated at checkout.
            </p>
            <Button
            onClick={() => navigate("/checkoutpage")}
            className=" md:px-4 md:py-2 mt-4 rounded-xl bg-pink-500 hover:bg-pink-500 transition-all duration-300 hover:shadow-lg hover:shadow-pink-600 text-white text-xs font-normal "
            >
               Checkout
            </Button>
            </section>
